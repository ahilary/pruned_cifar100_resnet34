# -*- coding: utf-8 -*-
"""
Created on Wed Oct 25 07:47:38 2023
...
def fourth_level_pruning():
    
    base_second_prune = resnet_34_attention.resnet34_()
    
    base_second_prune.fc = nn.Linear(base_second_prune.fc.in_features, 100)
    
    
    # load the state dict of best epoch into the pruned model
    
    direct = r'C:\Users\Anish Hilary\RESNET\attention_cifar_100\results\21_11-14_06_40\resnet_34/'
    ...
    # now must transfer the weights from train_pruned_model to base_second_prune
...
if __name__ == '__main__':
    fourth_base_model = fourth_level_pruning()
