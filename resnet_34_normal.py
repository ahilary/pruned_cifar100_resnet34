# -*- coding: utf-8 -*-
"""
Created on Thu May  4 11:40:58 2023
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, t=None):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=100):
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], t='y')
    ...
    #         )
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, t))
